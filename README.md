...
**Note:** if the two dtm does not have exactly the same extent, they need to be clipped to the same extent 
using other software like QGIS.

The parameter `dtm1flip` or `dtm2flip` needs to be set to `True` if the orientation of the DTM went wrong.
